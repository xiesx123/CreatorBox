...
class EffectConfig(betterproto.Message):
    ...
    extra_map: Dict[str, str] = betterproto.map_field(16, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
...
class FansClub(betterproto.Message):
    ...
    prefer_data: Dict[int, "FansClubData"] = betterproto.map_field(2, betterproto.TYPE_INT32, betterproto.TYPE_MESSAGE)
...
class UserBadge(betterproto.Message):
    icons: Dict[int, "Image"] = betterproto.map_field(1, betterproto.TYPE_INT32, betterproto.TYPE_MESSAGE)
...
class RoomMessage(betterproto.Message):
    ...
    buried_point_map: Dict[str, str] = betterproto.map_field(30, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
