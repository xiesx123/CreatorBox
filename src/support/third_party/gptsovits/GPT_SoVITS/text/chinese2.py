...
import jieba_next as jieba_fast
import logging
...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(
        model_dir=f"{os.environ.get('sovits')}/GPT_SoVITS/pretrained_models/g2pw",
        model_source=os.environ.get("bert_base_path", f"{os.environ.get('sovits')}/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large"),
        v_to_u=False,
