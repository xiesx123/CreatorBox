...
def init_bigvgan():
    ...
    bigvgan_model = bigvgan.BigVGAN.from_pretrained("%s/GPT_SoVITS/pretrained_models/models--nvidia--bigvgan_v2_24khz_100band_256x" % (os.environ.get('sovits'),), use_cuda_kernel=False)
