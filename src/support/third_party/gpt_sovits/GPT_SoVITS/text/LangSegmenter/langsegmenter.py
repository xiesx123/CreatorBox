...
fast_langdetect.infer._default_detector = fast_langdetect.infer.LangDetector(fast_langdetect.infer.LangDetectConfig(cache_dir=os.path.join(os.environ.get("sovits"), "fast_langdetect")))
