...
if is_g2pw:
    ...
    from text.g2pw.g2pw import G2PWPinyin, correct_pronunciation

    parent_directory = os.path.dirname(current_file_path)
    g2pw = G2PWPinyin(
        model_dir=f"{os.environ.get('sovits')}/g2pw",
        model_source=os.environ.get("bert_base_path", "GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large"),
        v_to_u=False,
