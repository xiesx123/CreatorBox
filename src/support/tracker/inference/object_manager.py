...
from src.support.tracker.inference.object_info import ObjectInfo
...
class ObjectManager:
    ...
    def add_new_objects(self, objects: Union[List[ObjectInfo], ObjectInfo, List[int]]) -> (List[int], List[int]):  # type: ignore
