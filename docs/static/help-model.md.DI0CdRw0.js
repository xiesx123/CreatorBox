...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Trying to load the model directly from the local cache, if it exists.</span></span></code></pre></div><p>解决方法：<a href="https://hf-mirror.com" target="_blank" rel="noreferrer">通过国内镜像下载模型</a></p></div>`,6)]))}const k=a(l,[["render",i]]);export{m as __pageData,k as default};
