import{_ as d,C as l,c as g,o as E,j as s,a,G as n,au as p,w as t}from"./chunks/framework.DFKQrvug.js";const T=JSON.parse('{"title":"常见问题","description":"","frontmatter":{},"headers":[],"relativePath":"zh/help/faq.md","filePath":"_zh/help/faq.md","lastUpdated":1777565101000}'),c={name:"zh/help/faq.md"},u={id:"项目目录",tabindex:"-1"},y={class:"details custom-block"},F={id:"模型目录",tabindex:"-1"},b={class:"details custom-block"},m={id:"显卡使用",tabindex:"-1"},C={class:"details custom-block"},v={id:"请求已过期",tabindex:"-1"};function B(f,i,x,P,D,q){const k=l("NolebasePageProperties"),e=l("Badge"),h=l("LiteTree"),r=l("PluginTabsTab"),o=l("PluginTabs");return E(),g("div",null,[i[24]||(i[24]=s("h1",{id:"常见问题",tabindex:"-1"},[a("常见问题 "),s("a",{class:"header-anchor",href:"#常见问题","aria-label":'Permalink to "常见问题"'},"​")],-1)),i[25]||(i[25]=a()),n(k),i[26]||(i[26]=s("p",null,"安装使用问题汇总",-1)),i[27]||(i[27]=a()),i[28]||(i[28]=s("h2",{id:"目录",tabindex:"-1"},[a("目录 "),s("a",{class:"header-anchor",href:"#目录","aria-label":'Permalink to "目录"'},"​")],-1)),i[29]||(i[29]=a()),s("h3",u,[i[0]||(i[0]=a("项目目录 ",-1)),n(e,{type:"danger",text:"new"}),i[1]||(i[1]=a()),i[2]||(i[2]=s("a",{class:"header-anchor",href:"#项目目录","aria-label":'Permalink to "项目目录 <Badge type="danger" text="new" />"'},"​",-1))]),i[30]||(i[30]=a()),s("details",y,[i[4]||(i[4]=s("summary",null,[a("说明 "),s("code",null,"CreatorBox"),a(" 文件夹下的 "),s("strong",null,[s("code",null,"目录")]),a(" 和 "),s("strong",null,[s("code",null,"文件")])],-1)),i[5]||(i[5]=a()),n(h,null,{default:t(()=>[...i[3]||(i[3]=[a(`
webapp                              // 应用目录
    + cache                         // 缓存
        llm/                        // LLM
        request/                    // 请求
        ...
        - test                      // 视频目录
            + _v1                   // 输出目录
                ...
                + tts               // 语音合成文件夹
                    ...
                    - ...               
            + draft                 // 草稿目录
                - draft_input.json   // 内容输入
                - draft_content.json // 草稿输出
            + stems                 // 音轨分离
                - vocals.wav        // 说话人声
