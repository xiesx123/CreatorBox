import{_ as o,C as e,c,o as d,j as s,G as i,aH as l,a,w as p}from"./chunks/framework.DKkyJa8M.js";const v=JSON.parse('{"title":"FAQ","description":"","frontmatter":{},"headers":[],"relativePath":"help/faq.md","filePath":"_en/help/faq.md","lastUpdated":1776744857000}'),k={name:"help/faq.md"},u={class:"details custom-block"};function g(b,n,E,m,y,F){const r=e("NolebasePageProperties"),t=e("PluginTabsTab"),h=e("PluginTabs");return d(),c("div",null,[n[3]||(n[3]=s("h1",{id:"faq",tabindex:"-1"},[a("FAQ "),s("a",{class:"header-anchor",href:"#faq","aria-label":'Permalink to "FAQ"'},"​")],-1)),i(r),n[4]||(n[4]=l("",8)),s("details",u,[n[2]||(n[2]=l("",6)),i(h,null,{default:p(()=>[i(t,{label:"Tesla T4"},{default:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-logs vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"logs"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",null,"Sat Jul 12 14:42:54 2025")]),a(`
...
`),s("span",{class:"line"},[s("span",null,"|                                         |                        |                  N/A |")]),a(`
`),s("span",{class:"line"},[s("span",null,"+-----------------------------------------+------------------------+----------------------+")])])])],-1)])]),_:1})]),_:1})]),n[5]||(n[5]=l("",21))])}const f=o(k,[["render",g]]);export{v as __pageData,f as default};
