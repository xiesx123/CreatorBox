import{_ as a,c as n,o as p,ag as i}from"./chunks/framework.DqNmUwpQ.js";const d=JSON.parse('{"title":"名词解释","description":"","frontmatter":{},"headers":[],"relativePath":"help-glossary.md","filePath":"help-glossary.md"}'),l={name:"help-glossary.md"};function t(e,s,h,k,c,o){return p(),n("div",null,s[0]||(s[0]=[i(`<h1 id="名词解释" tabindex="-1">名词解释 <a class="header-anchor" href="#名词解释" aria-label="Permalink to &quot;名词解释&quot;">​</a></h1><h2 id="目录说明" tabindex="-1">目录说明 <a class="header-anchor" href="#目录说明" aria-label="Permalink to &quot;目录说明&quot;">​</a></h2><p><code>webapp</code> 文件夹下 <strong><code>子目录</code></strong>、<strong><code>文件</code></strong> 解释</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─cache 缓存</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]</span></span></code></pre></div>`,7)]))}const E=a(l,[["render",t]]);export{d as __pageData,E as default};
