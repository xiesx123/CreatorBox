import{_ as n,c as a,o as p,al as i}from"./chunks/framework.DniHh94O.js";const d=JSON.parse('{"title":"名词解释","description":"","frontmatter":{},"headers":[],"relativePath":"help-glossary.md","filePath":"help-glossary.md","lastUpdated":1744484225000}'),l={name:"help-glossary.md"};function e(t,s,r,h,c,k){return p(),a("div",null,s[0]||(s[0]=[i(`<h1 id="名词解释" tabindex="-1">名词解释 <a class="header-anchor" href="#名词解释" aria-label="Permalink to &quot;名词解释&quot;">​</a></h1><h2 id="目录说明" tabindex="-1">目录说明 <a class="header-anchor" href="#目录说明" aria-label="Permalink to &quot;目录说明&quot;">​</a></h2><p><code>webapp</code> 文件夹下 <strong><code>子目录</code></strong>、<strong><code>文件</code></strong> 解释</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>.</span></span>
