import{_ as k,C as l,c,o,j as s,G as i,aF as e,a,w as p}from"./chunks/framework.COOt9ThZ.js";const v=JSON.parse('{"title":"常见问题 ❓","description":"","frontmatter":{},"headers":[],"relativePath":"zh/help/faq.md","filePath":"_zh/help/faq.md","lastUpdated":1775887362000}'),d={name:"zh/help/faq.md"},g={class:"details custom-block"};function u(b,n,E,m,y,F){const r=l("NolebasePageProperties"),t=l("PluginTabsTab"),h=l("PluginTabs");return o(),c("div",null,[n[3]||(n[3]=s("h1",{id:"常见问题-❓",tabindex:"-1"},[a("常见问题 ❓ "),s("a",{class:"header-anchor",href:"#常见问题-❓","aria-label":'Permalink to "常见问题 ❓"'},"​")],-1)),i(r),n[4]||(n[4]=e("",8)),s("details",g,[n[2]||(n[2]=e("",6)),i(h,null,{default:p(()=>[i(t,{label:"Tesla T4"},{default:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-logs vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"logs"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",null,"Sat Jul 12 14:42:54 2025")]),a(`
...
`),s("span",{class:"line"},[s("span",null,"|                                         |                        |                  N/A |")]),a(`
`),s("span",{class:"line"},[s("span",null,"+-----------------------------------------+------------------------+----------------------+")])])])],-1)])]),_:1})]),_:1})]),n[5]||(n[5]=e("",19))])}const B=k(d,[["render",u]]);export{v as __pageData,B as default};
